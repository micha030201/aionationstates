...
def test_move():
    ...
    assert h.region_from == Region('the_east_pacific')
    assert h.region_to == Region('the_north_pacific')
...
def test_founding():
    ...
    assert h.agent == Nation('testlandia')
    assert h.region == Region('the_east_pacific')
...
def test_cte():
    ...
    assert h.patient == Nation('testlandia')
    assert h.region == Region('the_east_pacific')
...
def test_delegate_remove():
    ...
    assert h.old_delegate == Nation('testlandia')
    assert h.region == Region('the_east_pacific')
...
def test_delegate_install():
    ...
    h = happenings.process_happening(happening_elem(t))
    assert type(h) is happenings.DelegateChange
    assert h.new_delegate == Nation('testlandia')
...
def test_delegate_change():
    ...
    assert type(h) is happenings.DelegateChange
    assert h.new_delegate == Nation('testlandia')
    assert h.old_delegate == Nation('aidnaltset')
    assert h.region == Region('the_east_pacific')
...
def test_embassy_propose():
    ...
    assert h.agent == Nation('testlandia')
    assert h.regions == frozenset(frozenset((Region('the_east_pacific'), Region('the_north_pacific'))))
...
def test_embassy_agree():
    ...
    assert h.agent == Nation('testlandia')
    assert h.regions == frozenset((Region('the_east_pacific'), Region('the_north_pacific')))
...
def test_endorse():
    ...
    assert h.agent == Nation('testlandia')
    assert h.patient == Nation('aidnaltset')
...
def test_zombie_cleanse():
    ...
    h = happenings.process_happening(happening_elem(t))
    assert type(h) is happenings.ZombieKill
    assert h.patient == Nation('testlandia')
    assert h.agent == Nation('landtestia')
    assert h.impact == 195
...
def test_zombie_ravage():
    ...
    h = happenings.process_happening(happening_elem(t))
    assert type(h) is happenings.ZombieInfect
    assert h.patient == Nation('testlandia')
    assert h.agent == Nation('landtestia')
    assert h.impact == 70
...
def test_zombie_cure():
    ...
    h = happenings.process_happening(happening_elem(t))
    assert type(h) is happenings.ZombieCure
    assert h.patient == Nation('testlandia')
    assert h.agent == Nation('landtestia')
    assert h.impact == 5
...
def test_dismiss_oficer():
    ...
    assert h.agent == Nation('testlandia')
    assert h.patient == Nation('qwerty')
    assert h.title == 'asdf'
